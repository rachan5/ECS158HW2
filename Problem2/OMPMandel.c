//compile with −D , e.g.
//
//gcc −fopenmp −o manddyn OMPMandel.c −DDYNAMIC
//
...
float ntimediff(struct timespec t1, struct timespec t2)
{ 
...
#ifdef RC
 // f i n d s chunk among 0 , . . . , n−1 to a s s i g n to thread number me among nth
 // threads
...
#include <stdlib.h>
#include <stdio.h>
// from http ://www. c i s . temple . edu/˜ i n g a r g i o / c i s 7 1 / code /randompermute . c
// I t returns a random permutation of 0 . . n−1
int* rpermute (int n) {
